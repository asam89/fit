...
async def dashboard_home(request: Request):
    ...
    water_target = targets.get("water_ml", 2800) or 2800
    ...
    pct["water"] = min(100, int((totals.get("water_ml", 0) or 0) / water_target * 100))
    pct["sat_fat"] = 0  # no target for sat_fat, just track consumption
